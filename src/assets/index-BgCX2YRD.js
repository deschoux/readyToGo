...
function eu(e, n, t, r) {
  if (Dr) {
    var l = fo(e, n, t, r);
    if (l === null) jl(e, n, r, Fr, t), Xu(e, r);
    else if (nf(l, e, n, t, r)) r.stopPropagation();
    else if ((Xu(e, r), n & 4 && -1 < ef.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && Ts(o),
...
function Bs(e) {
  if (e.propertyName === "value" && rl(It)) {
    var n = [];
    As(n, It, e, Zo(e)), ks(Mf, n);
  }
}
function Df(e, n, t) {
  e === "focusin"
    ? (li(), (_t = n), (It = t), _t.attachEvent("onpropertychange", Bs))
    : e === "focusout" && li();
}
function Ff(e) {
...
function hn() {
  if (!Fl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), _s(Jo, hn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
function _a(e, n, t) {
  return Pn & 21
    ? (Me(t, n) || ((t = zs()), (A.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function Va(e) {
  ...
  n !== null && ((e.alternate = null), Va(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[wo], delete n[Zf], delete n[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), pe(n, Q()), !(R & 6) && ((lt = Q() + 500), hn()));
      }
      break;
    case 13:
      Ln(function () {
...
ws = Nu;
Ss = Ln;
var Td = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, ys, gs, Nu] },
  yt = {
...
function Wi({ name: e, bool: n, setBool: t }) {
  const r = e === "ON" ? n : !n;
  return I.jsx("button", {
    className: "bouton",
    onClick: () => {
      e === "ON" && !n && t(!n), e === "OFF" && n && t(!n);
    },
    style: {
      color: r ? "white" : "blue",
      backgroundColor: r ? "blue" : "white",
    },
    children: e,
  });
}
function Ql({ bool: e, setBool: n }) {
  return I.jsxs("div", {
    className: "switch-cont0",
    children: [
      I.jsx(Wi, { name: "ON", bool: e, setBool: n }),
      I.jsx(Wi, { name: "OFF", bool: e, setBool: n }),
    ],
  });
}
function Md({ stop: e }) {
  return I.jsxs("div", {
    className: "header-cont0",
    children: [
      I.jsxs("div", {
        ...
        children: [
          ...
          I.jsx("p", { children: "Ready To Go" }),
        ],
      }),
      I.jsx("button", { className: "stop", onClick: e, children: "STOP" }),
    ],
  });
}
function jd({ name: e }) {
  return I.jsxs("div", {
    className: "footer-cont0",
    children: [
      "Création ",
      I.jsx("strong", { children: "ReadyToGo" }),
      " pour ",
      I.jsx("strong", { children: "Le Reacteur" }),
      " par ",
      I.jsx("strong", { children: e }),
    ],
  });
}
function Dd() {
  const [e, n] = Qn.useState(!1),
    [t, r] = Qn.useState(!1),
    [l, o] = Qn.useState(!1),
    u = () => {
      n(!1), r(!1), o(!1);
      ...
      I.jsxs("div", {
        ...
        children: [
          I.jsxs("div", {
            className: "app-cont2",
            children: [
              I.jsx(Ql, { bool: e, setBool: n }),
              I.jsx(Ql, { bool: t, setBool: r }),
              I.jsx(Ql, { bool: l, setBool: o }),
            ],
          }),
          I.jsx("button", {
            className: "ready",
            style: { backgroundColor: e && t && l ? "green" : "red" },
            children: `${e && t && l ? "GO !" : "NO WAY !"}`,
          }),
        ],
      }),
      I.jsx(jd, { name: "Daniel" }),
    ],
  });
}
Kl.createRoot(document.getElementById("root")).render(
  I.jsx(kc.StrictMode, { children: I.jsx(Dd, {}) })
);
